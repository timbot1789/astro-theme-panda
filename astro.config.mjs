...
const nightOwlDark = new ExpressiveCodeTheme(parse(readFileSync('./src/styles/expressive-code/night-owl-dark.jsonc', 'utf-8')));
const nightOwlLight = new ExpressiveCodeTheme(parse(readFileSync('./src/styles/expressive-code/night-owl-light.jsonc', 'utf-8')));
const {
  site,
  defaultLocale
} = PandaConfig;
...
export default defineConfig({
  ...
  integrations: [UnoCSS(), sitemap(), expressiveCode({
